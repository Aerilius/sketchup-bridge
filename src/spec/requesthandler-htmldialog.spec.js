...
describe('RequestHandler for HtmlDialog', () => {
  ...
  beforeEach(() => {
    ...
    sketchup = { [CALLBACKNAME]: chai.spy() }
  ...
  describe('#send', () => {
    ...
    it('should call the Ruby backend via sketchup', () => {
      let message = {}
      // Test
      requestHandler.send(message, () => {})
      expect(sketchup[CALLBACKNAME]).to.be.called.once.with(message)
    })
  })
  ...
  describe('#receive', () => {
    it('should accept an ID and an object', () => {
      ...
      // But causes a warning because no callback has been registered.
    })
  })
